...
const Login = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            // Login successful
            if (response.ok) {
                checkUser(); //Calling checkUser Function from context to update user upon login
        ...
        <div className="min-h-screen bg-gradient-to-r from-blue-100 via-blue-200 to-blue-100 flex items-center justify-center">
            <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-6">
                ...
                <form onSubmit={handleSubmit} className="bg-white max-w-md mx-auto h-2/3 w-full flex flex-col justify-between p-5 rounded-md">
                    ...
                    <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Login</button>
                </form>
